class int8mul_env extends bb_blink_env #(`BB_IN_BW, `BB_OUT_BW);
  `uvm_component_utils(int8mul_env)

  int8mul_scoreboard scb;
  int8mul_cov icov;
  ...
  function void build_phase(uvm_phase phase);
    ...
    scb  = int8mul_scoreboard::type_id::create("scb", this);
    icov = int8mul_cov::type_id::create("icov", this);
  endfunction
