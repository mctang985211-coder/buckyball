class maxpool_env extends bb_blink_env #(`BB_IN_BW, `BB_OUT_BW);
  `uvm_component_utils(maxpool_env)

  maxpool_scoreboard scb;
  maxpool_cov mcov;
  ...
  function void build_phase(uvm_phase phase);
    ...
    scb  = maxpool_scoreboard::type_id::create("scb", this);
    mcov = maxpool_cov::type_id::create("mcov", this);
  endfunction
